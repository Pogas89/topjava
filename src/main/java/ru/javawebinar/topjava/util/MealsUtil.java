...
public class MealsUtil {
    ...
    public static List<MealWithExceed> getWithExceeded(List<Meal> meals, int calPerDay){
        return getFilteredWithExceeded(meals,LocalTime.MIN,LocalTime.MAX,calPerDay);
    }
